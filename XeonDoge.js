//-----(Sk Bot by Sk Bot Inc.)-----\\
//-----(Youtube Channel: sk)-----\\
//-----(Whatsapp number: +6283135357223)-----\\
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = alpha.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*𝐒𝐤 𝐁𝐨𝐭*", "thumbnail": ftex, "surface": 'CATALOG' }}, {quoted:ftex})
             alpha.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = alpha.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '@g.us', "inviteCode": 'https://chat.whatsapp.com/', "groupName": `sk Bot Inc.`, "footerText": "*𝐒𝐤 𝐁𝐨𝐭*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		const sekarang = new Date().getTime();
			...
			var ase = new Date();
                        var jamss = ase.getHours();
                         switch(jamss){
                case 0: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 1: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 2: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 3: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 4: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 5: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 6: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 7: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 8: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 9: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 10: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 11: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 12: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 13: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 14: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 15: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 16: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 17: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 18: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 19: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 20: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 21: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 22: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
                case 23: jamss = "𝐒𝐤 𝐁𝐨𝐭"; break;
            }
...
const daftar3 = [{buttonId: `verify`,buttonText: {displayText: `🦋ᴠᴇʀɪғʏ🦋`,},type: 1,},]
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hi ${pushname}, Sorry it seems at this time ${NamaOwner} is offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minute, ${heheh.seconds} Second\n\nPlease contact again after Online`, "*𝐒𝐤 𝐁𝐨𝐭*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `𝐒𝐤 𝐁𝐨𝐭`,body:"ꪶsᴋ ᴅᴇᴠɪʟ sᴇʀꫂ",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/380945798078?text=*💌🥰sᴋ.ᴅᴇᴠɪʟ.sᴇʀ.ʙɪɢ.ғᴇɴ💌🥰`}}})
		}
		const simir = (teks) => {
...
sendButMessage(from, `${JSON.stringify(me, null, 2)}`, "*𝐒𝐤 𝐁𝐨𝐭*", [{buttonId: 'igm', buttonText: {displayText: 'Github'}, type: 1},{buttonId: 'ytm', buttonText: {displayText: 'YouTube'}, type: 1}], {quoted:ftex, contextInfo: { forwardingScore: 508, isForwarded: true}})
}
if(isButton == 'igm'){
reply('https://github.com/sk-ser')
}
...
┗━━━━━━━━━━━━━━━━━
buttons = [
{buttonId:`scbot`, buttonText: {displayText: 'ʙᴏᴛ sᴄʀɪᴘᴛ🔖'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: 'ʙᴏᴛ ᴏᴡɴᴇʀ👤'}, type: 1}
]
const menuu = {
    contentText: `${tod}`,
    footerText: `${tod2}`,
...
────────────────────`
buttons = [
{buttonId:`sc`,buttonText:{displayText: 'ʙᴏᴛ sᴄʀɪᴘᴛ🔖'},type:1},
{buttonId:`owner`, buttonText: {displayText: 'ʙᴏᴛ ᴏᴡɴᴇʀ👤'}, type: 1}
]
const grup = {
    contentText: `${stamtus}`,
...
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: mek})
          ...
          case 'wallml':
		      ...
		      buttons = [{buttonId: `waifu`,buttonText:{displayText: `➡️Next`},type:1},{buttonId:`owner`,buttonText:{displayText:'🦄ᴏᴡɴᴇʀ'},type:1}]
...
anu =`Please choose one below`
 buttons = [{buttonId: 'setmenu ori', buttonText: {displayText: 'ᴏʀɪ'}, type: 1},{buttonId: 'setmenu simple', buttonText: {displayText: 'sɪᴍᴘʟᴇ'}, type: 1}]
const skuygelud = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: buttons,
...
anu =`Please choose one below`
 buttons = [{buttonId: 'setallmenu ori', buttonText: {displayText: 'ᴏʀɪ'}, type: 1},{buttonId: 'setallmenu simple', buttonText: {displayText: 'sɪᴍᴘʟᴇ'}, type: 1}]
const skuygf = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: buttons,
...
──────────────────
*👇SCRIPT GITHUB LINK👇*
https://github.com/SKDEVIL/SER-V2
My Instagram Account : 
_BASE : sk Bot Inc._
_ORI SCRIPT : 𝐒𝐤 𝐁𝐨𝐭 Version 2_
_OWNER : ${NamaOwner}_
⍟ ────────────────── ⍟`
buttons = [
{buttonId:`donate`, buttonText: {displayText: 'ᴅᴏɴᴀᴛᴇ ʙᴏᴛ ᴏᴡɴᴇʀ'}, type: 1},
{buttonId:`owner`, buttonText: {displayText: 'ʙᴏᴛ ᴏᴡɴᴇʀ'}, type: 1}
]
const scbott = {
    contentText: `${anu}`,
...
"templateMessage": {
  ...
  "hydratedTemplate": {
    ...
    "hydratedButtons": [
      {
        "urlButton": {
          "displayText": `𝐒𝐤 𝐁𝐨𝐭 Script`,
          "url": "https://github.com/SKDEVIL/SER-V2"
        },
        "index": 0
      }
    ]
...
const buttons = [{buttonId: 'autotyping on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1},{buttonId: 'autotyping off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1}]
const btnharam = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: buttons,
      ...
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
           if (c === 'on'){
             antidelete = false
                    ...
                    anu =`Please select one\n\non: to enable\noff: to disable`
const buttons = [{buttonId: 'antidelete on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1},{buttonId: 'antidelete off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1}]
const buttonMessage = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: buttons,
...
punten = [{buttonId: 'antivirtex off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1},{buttonId: 'antivirtex on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1}]
const btnasu = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: punten,
...
await alpha.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftex})
 ...
 anu =`Please choose one\n\non: to enable\noff: to disable`
punten = [{buttonId: 'antiwame off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1},{buttonId: 'antiwame on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1}]
const btnasu = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: punten,
...
await alpha.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftex})
 ...
 anu =`Please choose one\n\non: to enable\noff: to disable`
punten = [{buttonId: 'antilink off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1},{buttonId: 'antilink on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1}]
const btnasu = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: punten,
...
await alpha.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftex})
 ...
 anu =`Please choose one\n\non: to enable\noff: to disable`
punten = [{buttonId: 'antibug off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1},{buttonId: 'antibug on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1}]
const btasu = {
    contentText: `${anu}`,
    footerText: '*𝐒𝐤 𝐁𝐨𝐭*',
    buttons: punten,
...
break 
         ...
         break
case 'gc': case 'group':
buttonss = [{buttonId: `opengc`, buttonText: {displayText: 'ᴏᴘᴇɴ'}, type: 1},{buttonId: `closegc`, buttonText: {displayText: 'ᴄʟᴏsᴇ'}, type: 1}]
const bMess = {
...
buttons = [{buttonId: `menu`, buttonText: {displayText: '🦋ᴍᴇɴᴜ🦋'}, type: 1},{buttonId: `owner`, buttonText: {displayText: '👤ᴏᴡɴᴇʀ👤'}, type: 1}]
const btnbc = {
    contentText: `${body.slice(4)}`,
    footerText: '*_𝐒𝐤 𝐁𝐨𝐭 𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓_*',
    buttons: buttons,
    headerType: 1
}
...
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('The text?')
                    teks = body.slice(12)
                    alpha.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`𝐒𝐤 𝐁𝐨𝐭`}, MessageType.location)
          ...
          reply('reply sticker/audio')
           ...
           case 'slanderpc':
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              alpha.groupUpdateSubject(from, `HACKED BY 𝐒𝐤 𝐁𝐨𝐭`)
...
for (let i = 0; i < args[0]; i++) {
alpha.sendMessage(from, `𝐒𝐤 𝐁𝐨𝐭`, MessageType.extendedText,{
 quoted: {
key: {
...
alpha.sendMessage(from, `𝐒𝐤 𝐁𝐨𝐭`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
_Note :_
ytmp3 => Music
ytmp4 => Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"🦋YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/mpLX_QAR7kY`}}})
            } catch(e) {
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: mek})
 ...
 anu =`Please select one\n\non: to enable\noff: to disable`
punten = [{buttonId: 'welcome off', buttonText: {displayText: 'ᴏғғ✖️'}, type: 1},{buttonId: 'welcome on', buttonText: {displayText: 'ᴏɴ✔️'}, type: 1}]
const btngrass = {
    contentText: `${anu}`,
    footerText: '*_𝐒𝐤 𝐁𝐨𝐭_*',
    buttons: punten,
