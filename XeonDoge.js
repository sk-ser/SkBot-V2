...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		...
		const reply = (teks) => {
			alpha.sendMessage(from, teks, text, { thumbnail: ofrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `𝐒𝐤 𝐁𝐨𝐭`,body:"𝗦𝝟 𝗗𝝣𝗩𝝞𝗟 𝗦𝝣𝗥",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/380945798078?text=*💌🥰sᴋ.ᴅᴇᴠɪʟ.sᴇʀ.ʙɪɢ.ғᴇɴ💌🥰`}}})
		}
		const simir = (teks) => {
